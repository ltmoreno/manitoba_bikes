...
(function () {
  ...
  function incrementValue(e) {
    ...
    var badge1 = document.getElementById("cart-badge1");
    badge1.innerText = parseInt(badge1.innerText) + 1;

    var badge2 = document.getElementById("cart-badge2");
  ...
  function decrementValue(e) {
    ...
    if (currentVal > 0) {
      ...
      var badge1 = document.getElementById("cart-badge1");
      if (parseInt(badge1.innerText) > 0)
        badge1.innerText = parseInt(badge1.innerText) - 1;

      var badge2 = document.getElementById("cart-badge2");
      if (parseInt(badge2.innerText) > 0)
        badge2.innerText = parseInt(badge2.innerText) - 1;
  ...
  if (fileInputs.length) {
    fileInputs.forEach(function (input) {
      input.addEventListener("change", function () {
        var curElement =
          input.parentElement.parentElement.querySelector(".image");
